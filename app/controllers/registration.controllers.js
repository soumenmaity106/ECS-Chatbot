...
exports.create = (req, res) => {
    ...
    Registration.find({ email: req.body.email })
        .then(result => {
            if (result.length >= 1) {
                res.status(400).send({
                    message: "This Email Address Alredy Used"
                })
            } else {
                var d = new Date();
                var n = d.getTime();
                ...
                const adminemail = {
                    to: 'soumen.ncrt@gmail.com',
                    from: 'soumen.ncrt@gmail.com',
                    subject: 'New User Register',
                    // text:`Username ${firstname} ${lastname} confir metion id ${n}`,
                                                            ...
                                                            <div style="line-height: 44px;">
                                                                <font face="Arial, Helvetica, sans-serif" size="5" color="#57697e" style="font-size: 34px;">
                                                                    <span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">
                                                                        Register User ${firstname} ${lastname}
                                                                    </span></font>
                                                            </div>
                                                            <!-- padding -->
                ...
                registration.save()
                    ...
                    .then(
                        mailer.sendMail(adminemail, (err, res) => {
                            if (err) {
                                console.log(err)
                            } else {
                                console.log(res)
